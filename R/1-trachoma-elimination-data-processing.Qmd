...
#-------------------------------
d <- read_rds(here("../../data/serology/final/ecomid_serology_datasets","ecomid_sero_antigen_seropos_long_2026-08-26.rds"))
...
#-------------------------------
dvisit <- read_rds(file=here("../../data/ecomid-field/final","ecomid_child_visit_info_2026-06-15.rds"))
...
# data are in long format
#-------------------------------
den <- read_rds(here("../../data/serology/final/dengue_serology_datasets","dengue_sero_antigen_seropos_long_2026-08-26.rds"))
...
write_rds(d5, file = here("data","ecuador_trachoma_elimination_data_2026-09-14.rds"))
write_csv(d5, file = here("data","ecuador_trachoma_elimination_data_2026-09-14.csv"))
```
